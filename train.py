...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.DLMPT = CN()
    cfg.TRAINER.DLMPT.LAMBDA = 0.2
    cfg.TRAINER.DLMPT.N_WAY = 20
    cfg.TRAINER.DLMPT.K_SUPPORT = 3
    cfg.TRAINER.DLMPT.K_QUERY = 10
    cfg.TRAINER.DLMPT.N_EPISODES = 100
    cfg.TRAINER.DLMPT.WARMUP_EPOCHS = 5
    cfg.TRAINER.DLMPT.REFINE_EPOCHS = 20
    cfg.TRAINER.DLMPT.REFINE_LAMBDA = 0.5
...
def choose_attribute_for_atprompt(cfg):
    if cfg.TRAINER.ATPROMPT.USE_ATPROMPT:
        ...
        elif cfg.DATASET.NAME == "ImageNet" or cfg.DATASET.NAME == "ImageNetSketch" or cfg.DATASET.NAME == "ImageNetA" or cfg.DATASET.NAME == "ImageNetR" or cfg.DATASET.NAME == "ImageNetV2":
        ...
        cfg.TRAINER.COOP.N_CTX = nc
        cfg.TRAINER.ATPROMPT.N_ATT1 = nc
        cfg.TRAINER.ATPROMPT.N_ATT2 = nc
        cfg.TRAINER.ATPROMPT.N_ATT3 = nc

        print(f"ATPrompt: {cfg.DATASET.NAME} N_CTX={nc} "
              f"att_num={cfg.TRAINER.ATPROMPT.ATT_NUM} "
              f"attrs={cfg.TRAINER.ATPROMPT.ATT1_TEXT},"
              f"{cfg.TRAINER.ATPROMPT.ATT2_TEXT},"
              f"{cfg.TRAINER.ATPROMPT.ATT3_TEXT}")
    else:
